...
public class Main {
	...
	public static void main(String[] args) {
		...
		// vet = new char[] { 's', 't', 'x', 'z', 'y' }; // vetor para os exemplos do
		// livro do cormen, OBS tam = 5*
		...
		if (g.bellmanFord(vs[0].getRotulo())) {
			System.out.println("\n\n****N�o tem solu��o pois tem ciclo negativo****");
		} else {
			System.out
					.println("\n\n----Foi poss�vel determinar o melhor caminho pois n�o encontrei ciclo negativo!----");
			g.mostraGrafo();
		}
